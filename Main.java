...
public class Main {
    public static void main(String[] args) {
        ...
        // Create a customer
        Customer customer = new Customer("John Doe", "123 Main St", "123-456-7890", "johndoe@example.com", "Toyota Corolla");
        Customer customer2 = new Customer("Jane Doe", "789 Second St", "987-654-3210", "janedoe@example.com", "Honda Civic");
