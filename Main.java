public class Main {
    public static void main(String[] args) {
        ...
        customer.sendInquiry("I am interested in " + car.getMake() + " " + car.getModel() + ". And i have a budget of " + customer.getPriceRange() + " dollars.");
        ...
        customer2.sendInquiry("I am interested in " + luxuryCar.getMake() + " " + luxuryCar.getModel() + ". And i have a budget of " + customer2.getPriceRange() + " dollars.");
        dealer.respondToInquiry(customer2, luxuryCar, car2);
        customer2.respondToOffer(dealer, luxuryCar, car2);
        dealer.sellCar(customer2, luxuryCar, car2);
